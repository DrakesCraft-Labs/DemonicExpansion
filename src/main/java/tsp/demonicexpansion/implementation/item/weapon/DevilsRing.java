...
public class DevilsRing extends DemonicWeapon implements Unburnable {
    ...
    public void onRightClick(PlayerRightClickEvent event) {
        ...
        }, left -> PlayerUtils.sendMessage(event.getPlayer(), "&cNo puedes reemplazar esto por otro.: &e" + left + "s")); // No sound because it would be deafening when spammed on cooldown.
    }
